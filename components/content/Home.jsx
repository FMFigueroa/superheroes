...
const Home = (props) => {
  ...
  const { hero, loading, success, message, error } = useSelector(
    (state) => state.searchHero
  );
  ...
  return (
    <div className="sectionTwo container">
      <h1 className={styles.title}>
        Welcome to <a href="https://superheroapi.com/ids.html">Superheros</a>
      </h1>
      <p className={styles.description}>
        Get started by searching you favorite Superheros
      </p>
