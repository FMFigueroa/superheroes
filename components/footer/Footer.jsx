    ...
    <footer className="footer section" id="contact">
      <div className="footer__container containerGlobal grid">
        ...
        <div className="footer__content">
          ...
          <ul className="footer__data">
            <li className="footer__information">
              <i className="ri-map-pin-line footer__country-link"></i>
              Remote
            </li>
            <li className="footer__information">
              <i className="ri-building-2-line footer__country-link"></i>
            </li>
          </ul>
        </div>
        ...
        <div className="footer__content">
          ...
          <ul className="footer__data">
            <li className="footer__information">
              <i className="ri-mail-send-line footer__contact-link"></i>{" "}
              felixmanuelfigueroa@gmail.com
            </li>
